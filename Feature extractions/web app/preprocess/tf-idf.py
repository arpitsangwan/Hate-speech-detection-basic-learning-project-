...
data=pd.read_csv('C:\\Users\\arpit\\OneDrive\\Desktop\\AI\\Feature extractions\\web app\\labels.csv',encoding = 'utf8')
tweet = data['tweet']

# dictionary into a list
dict=pd.read_csv('C:\\Users\\arpit\\OneDrive\\Desktop\\AI\\dictionaries\\hatebase_dict.csv', encoding = 'ISO-8859-1')
dict2 = dict.iloc[:,0]
dic = []
for row in dict2:
    row = row.strip("',")
...
file=open("C:\\Users\\arpit\\OneDrive\\Desktop\\AI\\Feature extractions\\web app\\preprocess\\tfidf_scores.csv", 'w',newline='')
with file:
