...
data=pd.read_csv('C:\\Users\\arpit\\OneDrive\\Desktop\\AI\\Extracted datasets\\cleaned_tweets.csv',encoding = 'ISO-8859-1')
...
data=data.drop(['index','class','tweet','clean_tweet'],axis=1)
